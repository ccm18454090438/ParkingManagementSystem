package com.ustcsse.auth.utils;
...
public class JwtUtil {
    ...
    //有效期为
    public static final Long JWT_TTL = 600 * 60 *1000L;// 600 * 60 *1000  十个小时
    //设置秘钥明文
    public static final String JWT_KEY = "appnamezhihuitingcheguanlixitongfromustcsse";
    ...
    public static String createJWT(String subject) {
        JwtBuilder builder = getJwtBuilder(subject, 36000000L, getUUID());// 设置过期时间
