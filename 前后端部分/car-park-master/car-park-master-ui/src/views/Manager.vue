    ...
    <el-container>
      ...
      <el-aside :width="asideWidth" style="min-height: 100vh; background-color: #001529">
        <div style="height: 60px; color: white; display: flex; align-items: center; justify-content: center">
          ...
          <span class="logo-title" v-show="!isCollapse" style="font-size: medium;">智慧停车后台系统</span>
        </div>
        ...
        <el-menu :default-openeds="['info']" :collapse="isCollapse" :collapse-transition="false" router
          ...
          <el-menu-item index="/car">
            ...
            <span slot="title">在库车辆</span>
          </el-menu-item>
          <el-menu-item index="/record">
            <i class="el-icon-notebook-2"></i>
            <span slot="title">停车记录</span>
          </el-menu-item>
          <!-- <el-menu-item index="/park" v-if="user.role === '管理员'">
...
export default {
  ...
  mounted() {   // 页面加载完成之后触发
    if (!localStorage.getItem('honey-user')) {   // 当前的浏览器没有用户信息
